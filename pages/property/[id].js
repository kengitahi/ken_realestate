...
export default function PropertyDetails({ propertyDetails: { price, description, type, rentFrequency, rooms, title, baths, area, agency, isVerified, externalID, purpose, furnishingStatus, amenities, photos } }) {
    return (
        <Box maxWidth="1000px" margin="auto" p="4">
            ...
            <Box w="full" p="6">
                <Flex justifyContent="space-between" alignItems="center" paddingTop="2" paddingBottom="2">
                ...
                <Flex alignItems="center" justifyContent="space-between" w="250px" color="blue.400" padding="1" paddingBottom="2">
                    {rooms} <FaBed /> | {baths} <FaBath /> | {millify(area)} sqft <BsGridFill />
                </Flex>
                <Box marginTop="2">
                    <Text fontSize="lg" marginBottom="2" fontWeight="bold" textTransform="uppercase">
                        {title}
                    </Text>
